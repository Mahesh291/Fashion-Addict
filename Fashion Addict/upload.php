...
<div style="width:30%;float:left; margin-left:10%;margin-top:100px;">

<form id="form" action="upload.php" method="post" enctype="multipart/form-data">
<input type="text" class="form-control" style="" name="name" placeholder="name" ><br/>
<input type="text" class="form-control" style="" name="title" placeholder="title"><br/>
<input type="file" class="form-control" style="" name="file" placeholder="product image"><br/>
<input type="text" class="form-control" style="" name="descr" placeholder="description"><br/>
<input type="text" class="form-control" style="" name="price" placeholder="price"><br/>
<input type="text" class="form-control" style="" name="off" placeholder="off"><br/>
<input type="text" class="form-control" style="" name="category" placeholder="category"><br/>
<input type="text" class="form-control" style="" name="type" placeholder="type"><br/>
<input type="text" class="form-control" style="" name="size" placeholder="size"><br/>
<input type="text" class="form-control" style="" name="background" placeholder="background"><br/>
...
<?php
   ...
   if(strpos($descr,'<script>') !== false){
	...
	$results = mysqli_query($con,"INSERT INTO products (name,title,descr,file,category,type,size,background,price,off,time) VALUES ('$name','$title','$descr','$file','$category','$type','$size','$background','$price','$off','$time2')") or die(mysqli_error());
