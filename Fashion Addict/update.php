...
<center>
<br/><br/>
<div style="width:50%; min-width:300px; border:1px solid rgb(200,200,200);padding:10px;">
<form action="update.php" method="get">
<h4 style="color:rgb(100,100,100);">Delivery Request</h4>
<input type="number" name="id1" style="min-width:100px; height:30px; border:1px solid rgb(20,20,20);">
<button name="update1" class="btn btn-primary" style="">Set As Delivered</button>
</form>
<form action="update.php" method="get">
<h4 style="color:rgb(100,100,100);">Sell Request</h4>
<input type="number" name="id2" style="min-width:100px; height:30px; border:1px solid rgb(20,20,20);">
<button name="update2" class="btn btn-primary" style="">Set As Reviewed</button>
</form>
</div>
...
$id = $_GET['id1'];
	...
	$results = mysqli_query($con,"UPDATE payment SET status = 1 WHERE (id = '$id')") or die(mysqli_error());
}
?>
<?php
...
$id = $_GET['id2'];
	...
	$results = mysqli_query($con,"UPDATE sell SET status = 1 WHERE (id = '$id')") or die(mysqli_error());
}
?>